...
# D->C->A
sudo ovs-ofctl add-flow s4 priority=1000,in_port=4,dl_type=0x0800,nw_proto=6,tcp_dst=80,actions=output:2
sudo ovs-ofctl add-flow s3 priority=1000,in_port=3,dl_type=0x0800,nw_proto=6,tcp_dst=80,actions=output:1
sudo ovs-ofctl add-flow s1 priority=1000,in_port=3,dl_type=0x0800,nw_proto=6,tcp_dst=80,actions=output:1
